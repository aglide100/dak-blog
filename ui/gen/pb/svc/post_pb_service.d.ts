...
export class PostClient {
  ...
  createPost(
    ...
    callback: (
      ...
      responseMessage: pb_svc_post_pb.CreatePostRes | null
    ) => void
  ): UnaryResponse;
  createPost(
    requestMessage: pb_svc_post_pb.CreatePostReq,
  ...
  deletePost(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: pb_svc_post_pb.DeletePostRes | null
    ) => void
  ): UnaryResponse;
  deletePost(
    requestMessage: pb_svc_post_pb.DeletePostReq,
  ...
  getPost(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: pb_svc_post_pb.GetPostRes | null
    ) => void
  ): UnaryResponse;
  getPost(
    requestMessage: pb_svc_post_pb.GetPostReq,
  ...
  createComment(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: pb_svc_post_pb.CreateCommentRes | null
    ) => void
  ): UnaryResponse;
  createComment(
    requestMessage: pb_svc_post_pb.CreateCommentReq,
  ...
  updatePost(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: pb_svc_post_pb.UpdatePostRes | null
    ) => void
  ): UnaryResponse;
  updatePost(
    requestMessage: pb_svc_post_pb.UpdatePostReq,
