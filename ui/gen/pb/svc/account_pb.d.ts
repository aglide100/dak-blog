...
export class GetAccountReq extends jspb.Message {
  hasToken(): boolean;
  clearToken(): void;
  getToken(): pb_unit_account_account_pb.Account | undefined;
  setToken(value?: pb_unit_account_account_pb.Account): void;
...
export namespace GetAccountReq {
  export type AsObject = {
    token?: pb_unit_account_account_pb.Account.AsObject,
  }
}
