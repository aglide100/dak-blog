...
goog.provide('proto.pb.unit.post.Comments');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.pb.unit.comment.Comment');
...
proto.pb.unit.post.Comments.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.pb.unit.comment.Comment.toObject, includeInstance)
  };
...
proto.pb.unit.post.Comments.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.pb.unit.comment.Comment;
      reader.readMessage(value,proto.pb.unit.comment.Comment.deserializeBinaryFromReader);
...
proto.pb.unit.post.Comments.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.pb.unit.comment.Comment.serializeBinaryToWriter
    );
  }
};
...
proto.pb.unit.post.Comments.prototype.getCommentList = function() {
  return /** @type{!Array<!proto.pb.unit.comment.Comment>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.pb.unit.comment.Comment, 1));
};


/**
 * @param {!Array<!proto.pb.unit.comment.Comment>} value
 * @return {!proto.pb.unit.post.Comments} returns this
*/
