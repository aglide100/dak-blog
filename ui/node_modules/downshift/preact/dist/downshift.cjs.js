...
function isDOMElement(element) {
  ...
  /* istanbul ignore if */
  return typeof element.type === 'string' || typeof element.nodeName === 'string'; // then we assume this is react
}
/**
 * @param {Object} element (P)react element
...
var MenuMouseLeave = process.env.NODE_ENV !== "production" ? '__menu_mouse_leave__' : 0;
var ItemMouseMove = process.env.NODE_ENV !== "production" ? '__item_mouse_move__' : 1;
var ItemClick = process.env.NODE_ENV !== "production" ? '__item_click__' : 2;
var ToggleButtonClick = process.env.NODE_ENV !== "production" ? '__togglebutton_click__' : 3;
var FunctionToggleMenu = process.env.NODE_ENV !== "production" ? '__function_toggle_menu__' : 4;
var FunctionOpenMenu = process.env.NODE_ENV !== "production" ? '__function_open_menu__' : 5;
var FunctionCloseMenu = process.env.NODE_ENV !== "production" ? '__function_close_menu__' : 6;
var FunctionSetHighlightedIndex = process.env.NODE_ENV !== "production" ? '__function_set_highlighted_index__' : 7;
var FunctionSelectItem = process.env.NODE_ENV !== "production" ? '__function_select_item__' : 8;
var FunctionSetInputValue = process.env.NODE_ENV !== "production" ? '__function_set_input_value__' : 9;
var FunctionReset = process.env.NODE_ENV !== "production" ? '__function_reset__' : 10; // to be used by useSelect and useCombobox

function productionEnumFn(state) {
  return process.env.NODE_ENV !== "production" ? state : 11;
}
...
if (process.env.NODE_ENV !== 'production') {
  validatePropTypes = function (options, caller) {
    PropTypes__default['default'].checkPropTypes(propTypes, options, 'prop', caller.name);
  };
}

var MenuKeyDownArrowDown = productionEnumFn('__menu_keydown_arrow_down__');
var MenuKeyDownArrowUp = productionEnumFn('__menu_keydown_arrow_up__');
var MenuKeyDownEscape = productionEnumFn('__menu_keydown_escape__');
var MenuKeyDownHome = productionEnumFn('__menu_keydown_home__');
var MenuKeyDownEnd = productionEnumFn('__menu_keydown_end__');
var MenuKeyDownEnter = productionEnumFn('__menu_keydown_enter__');
var MenuKeyDownSpaceButton = productionEnumFn('__menu_keydown_space_button__');
var MenuKeyDownCharacter = productionEnumFn('__menu_keydown_character__');
var MenuBlur = productionEnumFn('__menu_blur__');
var ToggleButtonKeyDownArrowDown = productionEnumFn('__togglebutton_keydown_arrow_down__');
var ToggleButtonKeyDownArrowUp = productionEnumFn('__togglebutton_keydown_arrow_up__');
var ToggleButtonKeyDownCharacter = productionEnumFn('__togglebutton_keydown_character__');
...
var stateChangeTypes$1 = /*#__PURE__*/Object.freeze({
  ...
  productionEnumFn: productionEnumFn
});
...
function downshiftSelectReducer(state, action) {
  ...
  switch (type) {
    ...
    default:
      return downshiftCommonReducer(state, action);
  }
...
var InputKeyDownArrowDown = productionEnumFn('__input_keydown_arrow_down__');
var InputKeyDownArrowUp = productionEnumFn('__input_keydown_arrow_up__');
var InputKeyDownEscape = productionEnumFn('__input_keydown_escape__');
var InputKeyDownHome = productionEnumFn('__input_keydown_home__');
var InputKeyDownEnd = productionEnumFn('__input_keydown_end__');
var InputKeyDownEnter = productionEnumFn('__input_keydown_enter__');
var InputChange = productionEnumFn('__input_change__');
var InputBlur = productionEnumFn('__input_blur__');
var ControlledPropUpdatedSelectedItem = productionEnumFn('__controlled_prop_updated_selected_item__');
...
if (process.env.NODE_ENV !== 'production') {
  validatePropTypes$1 = function (options, caller) {
...
function useCombobox(userProps) {
  ...
  preact.useEffect(function () {
    if ((initialIsOpen || defaultIsOpen || isOpen) && inputRef.current) {
...
var FunctionReset$1 = process.env.NODE_ENV !== "production" ? '__function_reset__' : 12;
